...
class BTractor(override val screenBox2d: AdvancedBox2dScreen): AbstractBody() {
    override val name       = "tractor"
    ...
    override var actor: AdvancedGroup? = AImage(screenBox2d, screenBox2d.game.allAssets.tractor)
