package com.tigerrealm.minimalizm.game.actors.checkbox
...
open class ACheckBox(
    ...
    open fun getListener() = object : InputListener() {
        ...
        override fun touchDown(event: InputEvent?, x: Float, y: Float, pointer: Int, button: Int): Boolean {
            screen.game.soundUtil.apply { play(s_click) }
    ...
    fun getStyleByType(type: Static.Type) = when(type) {
        Static.Type.MUSIC -> Static.ACheckBoxStyle(
            default = assets.yMusicDef,
            checked = assets.yMusicCheck,
        )
        Static.Type.PAUSE -> Static.ACheckBoxStyle(
            default = assets.yPauseDef,
            checked = assets.yPauseCheck,
        )
        Static.Type.BOX   -> Static.ACheckBoxStyle(
            default = assets.yBoxDef,
            checked = assets.yBoxPress,
        )
    }
