package com.tigerrealm.minimalizm.game.utils.advanced
...
import com.tigerrealm.minimalizm.game.utils.HEIGHT_UI
import com.tigerrealm.minimalizm.game.utils.ShapeDrawerUtil
import com.tigerrealm.minimalizm.game.utils.WIDTH_UI
import com.tigerrealm.minimalizm.game.utils.addProcessors
import com.tigerrealm.minimalizm.game.utils.disposeAll
import com.tigerrealm.minimalizm.game.utils.font.FontGenerator
import com.tigerrealm.minimalizm.game.utils.font.FontGenerator.Companion.FontPath
import com.tigerrealm.minimalizm.game.utils.region
import com.tigerrealm.minimalizm.util.cancelCoroutinesAll
...
abstract class AdvancedScreen(
    ...
    val fontGeneratorAksharRegular  = FontGenerator(FontPath.AksharRegular)
    val fontGeneratorAksharSemiBold = FontGenerator(FontPath.AksharSemiBold)
    ...
    override fun dispose() {
        ...
        disposeAll(
            ...
            fontGeneratorAksharRegular, fontGeneratorAksharSemiBold,
        )
    ...
    fun setUIBackground(texture: TextureRegion) {
        setBackBackground(game.loadingAssets.YellowLoading.region)
