package com.epicjourney.seredmora.game.actors.checkbox
...
open class ACheckBox(
    ...
    fun getStyleByType(type: Static.Type) = when(type) {
        Static.Type.PAUSE  -> Static.ACheckBoxStyle(
            default = assets.val_pause_def,
            checked = assets.val_pause_press,
        )
        Static.Type.OFF_ON -> Static.ACheckBoxStyle(
            default = assets.val_off,
            checked = assets.val_on,
        )
    }
