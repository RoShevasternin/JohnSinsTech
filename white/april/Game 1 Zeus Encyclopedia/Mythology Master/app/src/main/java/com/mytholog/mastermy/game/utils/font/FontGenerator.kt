package com.mytholog.mastermy.game.utils.font
...
class FontGenerator(fontPath: FontPath): FreeTypeFontGenerator(Gdx.files.internal(fontPath.path)) {
    ...
    companion object {
        enum class FontPath(val path: String) {
            Noah_Head_Bold     ("font/Noah-Head-Bold.ttf"),
            Noah_Head_ExtraBold("font/Noah-Head-ExtraBold.ttf"),
            Noah_Head_Medium   ("font/Noah-Head-Medium.ttf"),

            Olympus("font/Olympus.ttf"),
        }
    }
