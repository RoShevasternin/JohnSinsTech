package com.goalblast.onewingame.game.actors.button
...
import com.goalblast.onewingame.game.utils.TextureEmpty
import com.goalblast.onewingame.game.utils.actor.addAndFillActors
...
import com.goalblast.onewingame.game.utils.region
...
open class AButton(
    ...
    private fun getStyleByType(type: Type) = when(type) {
        ...
        Type.GAME -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.game_def),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.game_press),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.game_press),
        )
