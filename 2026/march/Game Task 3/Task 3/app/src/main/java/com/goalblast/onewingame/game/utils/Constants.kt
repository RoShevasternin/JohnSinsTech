package com.goalblast.onewingame.game.utils
...
const val WIDTH_BOX2D  = 10f
const val HEIGHT_BOX2D = 17.77f

const val METER_UI = WIDTH_UI / WIDTH_BOX2D

val Vector2.toB2 get() = this.divOr(METER_UI, 1f) // convert UI to Box2d
val Vector2.toUI get() = this.scl(METER_UI) // convert Box2d to UI
val Float.toB2 get() = this.divOr(METER_UI, 1f) // convert UI to Box2d
