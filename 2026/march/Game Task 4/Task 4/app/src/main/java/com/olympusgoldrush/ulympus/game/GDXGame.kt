package com.olympusgoldrush.ulympus.game
...
import com.olympusgoldrush.ulympus.MainActivity
import com.olympusgoldrush.ulympus.appContext
import com.olympusgoldrush.ulympus.game.manager.MusicManager
import com.olympusgoldrush.ulympus.game.manager.NavigationManager
...
import com.olympusgoldrush.ulympus.game.manager.util.MusicUtil
import com.olympusgoldrush.ulympus.game.manager.util.SoundUtil
import com.olympusgoldrush.ulympus.game.manager.util.SpriteUtil
import com.olympusgoldrush.ulympus.game.screens.LoaderScreen
import com.olympusgoldrush.ulympus.game.utils.GameColor
import com.olympusgoldrush.ulympus.game.utils.advanced.AdvancedGame
import com.olympusgoldrush.ulympus.game.utils.disposeAll
import com.olympusgoldrush.ulympus.game.utils.gdxGame
import com.olympusgoldrush.ulympus.util.Gist
...
class GDXGame(val activity: MainActivity) : AdvancedGame() {
    ...
    val sharedPreferences: SharedPreferences = appContext.getSharedPreferences("DATA", MODE_PRIVATE)
    ...
    private fun myLogic() {
        ...
        val savedData = sharedPreferences.getString("default", "noDATA") ?: "noDATA"
                ...
                coroutine.launch(Dispatchers.Main) {
                    ...
                    if (getJSON != null) {
                        if (getJSON.flag != "true") GDX_GLOBAL_isGame = true
                            ...
                            gdxGame.sharedPreferences.edit { putString("default", getJSON.link) }
