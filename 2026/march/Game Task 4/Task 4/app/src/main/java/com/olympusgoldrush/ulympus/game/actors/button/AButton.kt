package com.olympusgoldrush.ulympus.game.actors.button
...
import com.olympusgoldrush.ulympus.game.utils.TextureEmpty
import com.olympusgoldrush.ulympus.game.utils.actor.addAndFillActors
...
open class AButton(
    ...
    private fun getStyleByType(type: Type) = when(type) {
        ...
        Type.SETT -> AButtonStyle(
            ...
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.sett_press),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.sett_press),
        )
        Type.X -> AButtonStyle(
